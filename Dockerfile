...
# Install flutter sdk
RUN curl -L https://storage.googleapis.com/flutter_infra_release/releases/stable/linux/flutter_linux_${FLUTTER_SDK_VERSION}-stable.tar.xz -o /tmp/flutter-sdk.tar.xz && \
    tar -xf /tmp/flutter-sdk.tar.xz -C /opt/ && \
